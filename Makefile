...
40image-6: 40image.o compress40.o RGB_component.o a2blocked.o uarray2b.o uarray2.o compvid_words.o cosinespace_pixel.o read_in_out.o bit_convert.o bitpack.o word_pack_unpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
